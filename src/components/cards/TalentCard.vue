  ...
  <Card v-if="talent">
    <CardLink :href="getLink" target="_blank" class="p-0">
      <div class="h-full flex flex-col justify-between">
        <Icon
          v-if="isAdmin && props.talent.favorite"
        ...
        />
        <Icon
          v-else-if="isAdmin && !props.talent.favorite"
        ...
        />
        <Icon
          v-else-if="props.talent.favorite"
        ...
        <div class="p-4 flex items-center justify-center space-x-4 h-full">
          <img :src="props.talent.logo" alt="Talent Logo" height="28" width="28" class="rounded-lg">
          <div>
